...
(38, 5, 2025, 'Januari', 'PT Energi Mandiri', '0881810000', 'Nama Tenaga Teknik Anda', '00000000', 'MUHAMMAD IRWAN FIRDAUS', '00000000000', '088247342027', 'Kota Banjarbaru', '2.300,20', '-', '-', '-', '-', '11.000', 'diajukan', '-'),
(39, 10, 2025, 'Januari', 'WASAKA CODE DIGITAL DEVELOPMENT', '0881810000', 'Nama Tenaga Teknik Anda', '0988888888888', 'MUHAMMAD IRWAN FIRDAUS', '088247342027', '088247342027', 'Kota Banjarbaru', '2.341,4', '-', '-', '-', '-', '22000', 'diajukan', '-');
...
CREATE TABLE `parameter` (
  ...
  `hasil_so2` varchar(100) NOT NULL,
  `rencana_aksi_so2` varchar(225) NOT NULL,
  `baku_mutu_ho2` varchar(100) NOT NULL,
  `hasil_ho2` varchar(100) NOT NULL,
  `rencana_aksi_ho2` varchar(100) NOT NULL,
  `baku_mutu_tsp` varchar(100) NOT NULL,
  `hasil_tsp` varchar(100) NOT NULL,
  `rencana_aksi_tsp` varchar(225) NOT NULL,
  `baku_mutu_co` varchar(100) NOT NULL,
  `hasil_co` varchar(100) NOT NULL,
  `rencana_aksi_co` varchar(225) NOT NULL,
...
(52, 5, 'PT Energi Mandiri', 'Kota Banjarbaru', 'Komp.Husindo Raya', '114°5\'12\"BT', '3°26\'12\"LS', 'PLTD', 'Utama', '0,015', '0,015', '1', '1', '2009', 'Beroperasi', 'Solar', 'Liter', '30.000', 'diajukan', '-', 2025, 'Januari'),
(53, 5, 'PT Energi Mandiri', 'Kota Banjarbaru', 'Komp.Husindo Raya', '114°5\'12\"BT', '3°26\'12\"LS', 'PLTD', 'Utama', '1.259,8', '1.259,7', '1', '1', '2012', 'Beroperasi', 'Solar', 'Liter', '11.000', 'diajukan', '-', 2025, 'Februari'),
(54, 5, 'PT Energi Mandiri', 'Kota Banjarbaru', 'Komp.Husindo Raya', '114°5\'12\"BT', '3°26\'12\"LS', 'PLTD', 'Utama', '1.259,8', '1.259,7', '1', '1', '2013', 'Beroperasi', 'Solar', 'Liter', '11.000', 'diajukan', '-', 2025, 'Maret'),
(55, 10, 'WASAKA CODE DIGITAL DEVELOPMENT', 'Kota Banjarbaru', 'Komp.Husindo Raya', '114°5\'12\"BT', '3°26\'12\"LS', 'PLTD', 'Utama', '1.259,8', '1.259,7', '1', '1', '2012', 'Beroperasi', 'Solar', 'Liter', '11.000', 'diajukan', '-', 2025, 'Januari');
...
(21, 15, 'IF GROUP', 'Kota Banjarbaru', 'Komplek Husindo Raya', 'Hiburan dan Wisata', '088247342027', '0881810000', 'irwan', '081234567890', 'MUHAMMAD IRWAN FIRDAUS', '088247342027', 'mayamaulina16@gmail.com', 'diterima', '-');
...
(5, 'umum', 'irwanfirdaus508@gmail.com', '$2y$10$IfKG0EFwC/grk2sIy8fFzOKQnTgT51tXY5wdJ4IZZVZo5BNVU43HC', '00000099', 'umum', 'diverifikasi'),
...
(15, 'umum3', 'umum3@gmail.com', '$2y$10$vN6MZp/GJot3iMYpLOofseKQZfvc1eOMbnpgz2F2loA7RUMHb5HAC', '081234567891', 'umum', 'diverifikasi');
